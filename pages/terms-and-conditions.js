...
export default function TermsAndConditions() {
  return (
    <>
      <Head>
        <title>Optimus Battery- Terms and Conditions</title>
      ...
      <main>
        <Container sx={{ marginBlock: { xs: "75px", md: "100px" } }} fixed>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Optimus Battery and Power
                Solutions, Heavy Industrial Area, Chittagong, Bangladesh.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Optimus Battery, accessible
                from{" "}
                <a
          ...
          <h1>Governing Law</h1>
          <p>
            The laws of the Supremme Authority, excluding its conflicts of law
            rules, shall govern this Terms and Your use of the Service. Your use
            of the Application may also be subject to other rightful local,
          ...
          <ul>
            <li>By email: contact@optimusbattery.com</li>
          </ul>
        </Container>
      </main>
    </>
